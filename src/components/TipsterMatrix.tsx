      ...
      {race && (
        <div className="card mt-3">
          ...
          >
            ...
            <label className="field"><span>Units</span><input name="stake" id={`stake-${race.r.raceId}`} type="number" step="0.25" min="0.25" max="10" defaultValue="1" className="field-input w-20" /></label>
            ...
            <label className="field sm:col-span-5"><span>Why, one or two sentences</span><input name="comment" id={`why-${race.r.raceId}`} maxLength={280} className="field-input w-full" placeholder="Maps to lead on a track that favours leaders, and drops back in class." /></label>
